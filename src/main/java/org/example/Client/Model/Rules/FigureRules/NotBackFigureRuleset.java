...
import java.util.List;
    ...
    /**
     * figure ruleset where pons cant attack backwards
     */
    public class NotBackFigureRuleset implements FiguresRuleSet{
    ...
    public Figure initPon1Rules() {
        ...
        pon1Moves.add(new PonAttack(new Vector2[]{new Vector2(2,2),new Vector2(2,-2)}));
    ...
    public Figure initPon2Rules() {
        ...
        pon2Moves.add(new PonAttack(new Vector2[]{new Vector2(-2,-2),new Vector2(-2,2)}));
